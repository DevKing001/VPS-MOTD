...
echo -e "\033[1;36m🔐 HyperCloud - Secure SSH Configuration\033[0m"
...
bash <(curl -fsSL https://raw.githubusercontent.com/DevKing001/VPS-MOTD/motd.sh)
...
echo -e "\033[1;37m📌 HyperCloud VPS setup completed.\033[0m"
